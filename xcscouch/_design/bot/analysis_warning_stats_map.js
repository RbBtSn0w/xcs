function(doc) {
    if (doc.doc_type == 'integration' && doc.currentStep == 'completed' && doc.bot._id && doc.bot.tinyID) {
        if ((doc.buildResultSummary.analyzerWarningCount > 0) || (doc.buildResultSummary.warningCount > 0)) {
            var emitValue = doc.buildResultSummary.analyzerWarningCount + doc.buildResultSummary.warningCount;
            if (doc.xcsunittest) {
