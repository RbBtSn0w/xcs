...
describe("Notifications", function() {
    ...
    describe('report email', function () {
        ...
        describe('preparing', function() {
            fixtures.preload('request/notifications/before_report_preparation_result','request/notifications/after_report_preparation_results', 'response/notifications/after_report_preparation_results');
    ...
    //            var beforeResults = fixtures.getClone('request/notifications/tmp_before_preparation_results');
